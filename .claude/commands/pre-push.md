...
7. **Registry staleness**: `bash scripts/generate-registry-index.sh --check` — warns if structural index is stale (new routes, hooks, or files not captured). If stale, regenerate and update `product-registry.md`.
